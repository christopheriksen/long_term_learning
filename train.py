...
def main():
    ...
    weights_save_name = 'inceptionresnetv2_cifar100_imagenet_sgd_lr0.01_e10_v1.pth'
    ckpt_save_name = 'inceptionresnetv2_cifar100_imagenet_sgd_lr0.01_e10_v1_ckpt.pth'
    best_ckpt_save_name = 'inceptionresnetv2_cifar100_imagenet_sgd_lr0.01_e10_v1_best_ckpt.pth'

    load_order = True
    subset_instance_order_file = 'instance_order_0.txt'
    test_instances_file = 'test_instances_0.txt'

    accuracies_file = '/home/scatha/lifelong_object_learning/long_term_learning/accuracies/inceptionresnetv2_cifar100_imagenet_sgd_lr0.01_e10_v1.txt'
    ############################################
